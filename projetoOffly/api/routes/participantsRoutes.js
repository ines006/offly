 ...
 *     description: Updates the personal data (name, username, email, password, challenge_count, teams_id) of the authenticated participant. Only the participant themselves can update their own data. At least one field must be provided, and all provided fields must be valid.
 *     tags: [Participants]
 *     security:
 *       - bearerAuth: []
 *     parameters:
