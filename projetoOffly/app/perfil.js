...
const getRandomImage = () => {
      ...
      if (userId) {
        try {
          ...
          if (image) {
            ...
            Alert.alert('Erro', 'Utilizador não encontrado na Firestore.');
          }
        } catch (error) {
  ...
  const reauthenticateUser = async (currentPassword) => {
    try {
      ...
      console.error('Erro ao reautenticar o utilizador:', error);
        ...
        <Row>
          ...
          <InputRow>
            ...
            <EditButton onPress={() => (isEditingName ? handleSave('name') : setIsEditingName(true))}>
              ...
              accessibilityLabel = "press here to change your name"
              name={isEditingName ? 'check' : 'edit'} size={20} color="#263A83" />
            </EditButton>
          </InputRow>
        </Row>
        ...
        <Row>
          ...
          <InputRow>
            ...
            <EditButton onPress={() => (isEditingUsername ? handleSave('username') : setIsEditingUsername(true))}>
              <Icon
              accessibilityRole='button' 
              accessibilityLabel = "press here to change your username"
              name={isEditingUsername ? 'check' : 'edit'} size={20} color="#263A83" />
            </EditButton>
          </InputRow>
        </Row>
        ...
        <Row>
          ...
          <InputRow>
            <EditButton onPress={() => handleSave('password')}>
              <Icon
              accessibilityRole='button' 
              accessibilityLabel = "press here to change your password"
              name="edit" size={20} color="#263A83" /> 
            </EditButton>
          </InputRow>
        </Row>
