...
const DetalhesEquipa = () => {
  ...
  const handleRemoveParticipant = (participantId, participantUserName) => {
    console.log(
    ...
    <>
      ...
      {showMenu && (
        <View style={styles.menuDropdown}>
          ...
          >
            <Text style={[styles.menuOptionText, { color: "#D32F2F" }]}>Excluir equipa</Text>
          </TouchableOpacity>
        </View>
      )}
            ...
            <View style={styles.card}>
              ...
              {isAdmin && item.id && item.id != teamDetails.team_admin?.id && (
                <TouchableOpacity
                  ...
                  onPress={() => handleRemoveParticipant(item.id, item.username)}
                  accessibilityLabel={`Remover ${item.username} da equipa`}
                >
          ...
          <View style={styles.modalContainer}>
            {selectedParticipant?.error ? (
              ...
              <>
                ...
                <Text style={styles.modalMessage}>
                  Tens a certeza que queres remover {selectedParticipant?.username}{" "}
                  da tua equipa?
                </Text>
